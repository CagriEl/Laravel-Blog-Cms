...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | A string that denotes the default class (or classes) to give a navigation element
    | that is considered "active". This can be overrided on a case-by-case basis, but
